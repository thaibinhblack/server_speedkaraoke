    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            if($user)
            {
                ...
                ->join("table_room_bar_karaoke","table_booking.UUID_ROOM_BAR_KARAOKE","table_room_bar_karaoke.UUID_ROOM_BAR_KARAOKE")
                ->joi('table_detail_manager_bar_karaoke',"table_booking.UUID_BAR_KARAOKE", "table_detail_manager_bar_karaoke.UUID_BAR_KARAOKE")
                ...
                // ->where("table_user.UUID_USER",$user->UUID_USER)
