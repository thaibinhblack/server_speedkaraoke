    ...
    //    return response()->json($file, 200);
        ...
        if($request->has('sort'))
        {
            ...
            else if($request->get('sort') == 'groupby')
            {
                ...
                // return response()->json($karaokes, 200);
                $karaokes = DB::table("table_province")

                ->select("table_province.*",DB::table('table_bar_karaoke')->raw("SUM(table_bar_karaoke.ID_PROVINCE)"))
      
                ->join("table_bar_karaoke","table_bar_karaoke.ID_PROVINCE","=","table_province.ID_PROVINCE")
