...
class BillCotroller extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->where("UUID_BILL",$id)->select("table_bar_karaoke.LOGO_BAR_KARAOKE", "table_bar_karaoke.NAME_BAR_KARAOKE","table_bar_karaoke.ADDRESS_BAR_KARAOKE","table_bar_karaoke.PHONE_BAR_KARAOKE"
