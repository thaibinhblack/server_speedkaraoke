            ...
            if($user)
            {
                ...
                if($request->has('status'))
                {
                   if($request->get('status') == 'all')
                   {
                        ...
                        ->select("table_booking.*","table_bar_karaoke.LOGO_BAR_KARAOKE","table_bar_karaoke.NAME_BAR_KARAOKE","table_bar_karaoke.SAFE_URL" ,"table_room_bar_karaoke.NAME_ROOM_BAR_KARAOKE","table_room_bar_karaoke.RENT_COST")->get();
