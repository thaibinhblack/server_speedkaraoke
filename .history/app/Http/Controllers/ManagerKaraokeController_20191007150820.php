    ...
    public function index(Request $request)
    {
       if($request->has('api_token'))
       {
           ...
           if($user)
           {
                ...
                ->joi("table_room_bar_karaoke","table_detail_manager_bar_karaoke.UUID_ROOM_BAR_KARAOKE","table_room_bar_karaoke.UUID_ROOM_BAR_KARAOKE")
                ->where("UUID_USER",$user->UUID_USER)
                ->select("table_user.*","talbe_bar_karaoke.NAME_BAR_KARAOKE","table_room_bar_karaoke.NAME_ROOM_BAR_KARAOKE")
                ->get();
