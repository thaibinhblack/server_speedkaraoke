...
class BookingController extends Controller
{
        ...
        if($request->has('api_token')){
            ...
            if($user)
            {
                ...
                HistoryModel::create([
                    ...
                    "UUID_USER" => $user->UUID_USER,
                    "NAME_HISTORY" => 'Đặt phòng trực tiếp',
                    "CONTENT_ACTION" => $user->EMAIL.' đã đặt phòng trực tiếp cho khchs hàng '.$request->get("DISPLAY_NAME")
                ]);
                return response()->json([
                    'success' => true,
                    'message' => 'Tạo booking ngay thành công',
                    'result' => $booking,
                    'status' => 200
                ], 200);
            }
    ...
    public function get_booking_byday(Request $request,$id)
    {
