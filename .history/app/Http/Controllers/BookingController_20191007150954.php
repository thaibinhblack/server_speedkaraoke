    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            if($user)
            {
                ...
                ->join("table_room_bar_karaoke","table_detail_manager_bar_karaoke.UUID_ROOM_BAR_KARAOKE","table_room_bar_karaoke.UUID_ROOM_BAR_KARAOKE")
                ->where("UUID_BAR_KARAOKE",$request->get("UUID_BAR_KARAOKE"))->get();
