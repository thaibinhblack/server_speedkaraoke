...
class PromotionController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            if($user)
            {
                $promotion = PromotionModel::join('table_detail_promotion_karaoke','table_promotion.UUID_PROMOTION.UUID_PROMOTION','table_detail_promotion_karaoke.UUID_PROMOTION')
